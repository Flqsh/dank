...
module.exports = class extends Command {
    ...
    async run(message, args) {
        ...
        let pref = this.client.guildSettings.has(message.channel.id) ? (
        ...
        switch (args[0]) {
            ...
            default:
                return message.channel.send(`My prefix is currently \`${pref}\`. Use \`${pref}prefix set\` to set a prefix.`);
